...
WISHES = [
    ...
    "Нехай черговий тиждень запам'ятається тобі тільки хорошим 🌈",
    "Якщо щось впаде — ти вже знаєш що робити. Бо ти крутий 💪",
    "Нехай uptime буде 100% і настрій теж 🚀",
    "Якщо о 3 ночі задзвонить телефон — це просто хтось помилився номером 📵",
    "Нехай твої runbook-и ніколи не знадобляться 📖",
    "Тиждень без інцидентів — найкращий тиждень. Маємо всі шанси! ✨",
    ...
    "Хай на цьому тижні staging і prod поводяться однаково 🙏",
]
